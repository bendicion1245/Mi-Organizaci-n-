...
self.addEventListener('install', (evento) => {
  ...
  // NO se llama a skipWaiting() acá a propósito: la versión nueva se
  // queda "esperando" hasta que el usuario toque "Actualizar ahora"
  // en el cartel que muestra la app, para no interrumpirlo de golpe.
});

// --- Mensaje desde la app: el usuario tocó "Actualizar ahora" ---
...
// IMPORTANTE: las peticiones a Supabase (base de datos en tiempo real)
// NUNCA deben pasar por acá. Se dejan pasar directo a internet, sin
// interceptar ni guardar en caché, porque son datos que cambian todo
// el tiempo y necesitan llegar siempre frescos al servidor real.
